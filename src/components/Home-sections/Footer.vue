  ...
  <footer class="w-full bg-yellowBase">
    <div class="max-w-7xl flex justify-between text-black py-20 px-[4%] mx-auto">
      <div class="max-w-md space-y-4">
        ...
        <p>
          Ofrecemos soluciones digitales personalizadas combinando creatividad y
          tecnología para mejorar la presencia en línea y mejorar la visibilidad de
          nuestros clientes. Trabajaremos juntos para mejorar su éxito en línea.
        </p>
      </div>
      <div>
